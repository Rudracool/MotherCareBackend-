...
import ReorderItemCustomModel = require('../../ReorderItemExtension/JavaScript/ReorderItemCustom.Model');
import BackboneView = require('../../../Commons/BackboneExtras/JavaScript/Backbone.View');
import Backbone = require('../../../Commons/Utilities/JavaScript/backbone.custom');
import { ProfileModel } from '../../../Commons/Profile/JavaScript/Profile.Model';
// import ReorderItemCustomModel = require('../../ReorderItemExtension/JavaScript/ReorderItemCustom.Model');
// import '../../../Commons/Utilities/JavaScript/jQuery.jspdf.custom';
// import {jsPDF} from '../../../Commons/Utilities/JavaScript/jquery.jspdf.custom';
...
export const ListHeaderView: any = BackboneView.extend({
    ...
    initialize: function(options) {
        const { view } = options;
     this.CustomName=ProfileModel.getInstance();
    ...
    generateCsv:function generateCsv(jsonData){
        var headdingRows=(<any>Object).keys(jsonData[0]);
     ...
     csv += headdingRows;
     csv += '\n';
     _.each(jsonData,function(value:any){
     ...
     generatePdf:function(pdfData,Price){
        ...
        var headdingRows=(<any>Object).keys(pdfData[0]);
        ...
        var tr = '<tr class="bodySec">' ;
          _.map(pdfData,function(value:any,keys:number){
   ...
   var replaceData=getHtmlData.replace("headingContent1",headingText);
    ...
    getContext: function() {
        ...
        return {
            ...
            isVisible:this.isVisible,// custom to the get context
